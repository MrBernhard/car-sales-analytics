...
On the other hand, it was identified that the Chinese brands have increased significantly their sales in Mexico with ~400K units, from which ~97% correspond to ICVs and the rest to CEVs. In addition, it was identified that the brand "MG" is the current sales leader, followed by "JAC" and "Chery".

Finally, it was identified that to fulfill the second part of the project object which is:
